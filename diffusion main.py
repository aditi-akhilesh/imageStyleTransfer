...
def style_transfer(content_path, style_path, output_path, iterations=1000, style_weight=1e-2, content_weight=1e4):
...
if __name__ == "__main__":
    style_transfer(
        content_path="blend.png",
        style_path="images/style/scream.jpg",
        output_path="diffusionOutput.png",
        iterations=1000,
        style_weight=1e-2,
        content_weight=1e4,
    )
