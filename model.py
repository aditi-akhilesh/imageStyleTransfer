...
if __name__ == "__main__":
    style_transfer_image(
        "blend.png", "images/style/scream.jpg", save_name="gan-scream",
        style_weight=1e-2, content_weight=1e4, total_variation_weight=30,
    )
    style_transfer_image(
        "blend.png", "images/style/scream.jpg", save_name="gan-weighted",
        style_weight=1e-2, content_weight=3e4, total_variation_weight=30,
    )
    style_transfer_image(
        "blend.png", "images/style/scream.jpg", save_name="gan-styled",
